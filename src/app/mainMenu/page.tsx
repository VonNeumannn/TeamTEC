...
export default function MainMenuPage() {
	...
	useEffect(() => {
		const fetchData = async () => {
			...
			var modalidadActividadElement =
				document.getElementById("modalidadActividad");
			if (modalidadActividadElement) {
				modalidadActividadElement.innerText = modalidadActividad + "";
			}

			var semanaActividadElement =
				document.getElementById("semanaActividad");
			if (semanaActividadElement) {
				semanaActividadElement.innerText = semanaActividad + "";
			}

			var fechaActividadElement =
	...
	const changePasswordHandler = async (password: string) => {
		if (typeof window !== "undefined") {
			...
			if (storedData) {
				...
				const result = await handlerChangePassword(
					userData.id,
					password
				);
				if (result) {
