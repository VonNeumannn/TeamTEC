...
class Actividad {
	...
	private _fechaUltimoRecordatorio: Date;
	private observers: ActividadObserver[] = [];
	private _numRecordatorios: number;
	...
	constructor(
		...
		this._fechaUltimoRecordatorio = fechaUltimoRecordatorio;
		this._numRecordatorios = numRecordatorios;
	}
	// Getters
	get id() {
		return this._id;
	...
	get fechaUltimoRecordatorio() {
		return this._fechaUltimoRecordatorio;
	}
	get numRecordatorios() {
		return this._numRecordatorios;
	}
	// Setters
	set id(id: string) {
		this._id = id;
